...
class DatasetConfig(BaseModel):
    ...
    _model_type: Optional[Literal["protonet", "softkmeans", "softkmeansdistractor"]] = "protonet"
...
class TrainingConfig(BaseModel):
    ...
    logger: Optional[Literal["tensorboard", "wandb", "csv"]] = "wandb"
    logger_output_dir: str = "./models"
    _model_type: Optional[Literal["protonet", "softkmeans", "softkmeansdistractor"]] = "protonet"
